...
app = Flask(__name__)
app.secret_key = "unchadbitcharsha"
...
def get_Chat_response(text):
    ...
    if request.method == 'POST':
        query_input = request.form.get('msg')
        ...
        print(paragraphs[item[1]] for item in most_similar_chunks)
        ...
        if query_input:
            try:
                ...
                logging.warning(paragraphs[item[1]] for item in most_similar_chunks)
